...
<div id="all">
    ...
    <div class="main">
        ...
        <div class="lesson-block" id='artsegr'>
            <a href="nine-lesson.html" class="poperedniy-lesson"><h3><img src="images/icon/arrow-left.png" width="35px">
                На попередній урок</h3></a>
            <a href="six-lesson.html" class="next-lesson"><h3>На наступний урок <img
